...
const translations = {
    en: {
        ...
        checkboxLabel: "I would like a free customized quote for favorable prices and more.",
        submit: "Submit",
    ...
    nl: {
        ...
        checkboxLabel: "Ik wil gratis een op maat gemaakte offerte voor gunstige prijzen en meer.",
        submit: "Verzenden",
