        ...
        <footer className="inst-footer">
            <div className="inst-footer-container">
                ...
                <div className="inst-footer-brand">
                    ...
                    <div className="inst-footer-email">
                ...
                <div className="inst-middle-middle">
                    <div className="inst-footer-nav">
                ...
                <div className="inst-footer-social">
                    ...
                    <div className="inst-social-icons">
                        <a
                            href="https://www.linkedin.com/company/edgecapital1/"
                            target="_blank"
                            className="inst-social-icon"
                        >
                            <svg
            ...
            {/* Disclaimer Section */}
            <div className="inst-footer-disclaimer">
                <h3>
            ...
            <div className="inst-footer-bottom">
                ...
                <a href="/privacy" className="inst-footer-policy">
                    {language === "nl" ? "Privacybeleid" : "Privacy Policy"}
                </a>
            </div>
        </footer>
