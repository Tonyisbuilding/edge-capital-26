...
const ContactForm = () => {
  ...
  return (
    <div className="flex items-center justify-center h-full w-full pr-0 md:pr-8 lg:pr-8">
      <ToastContainer />
      <div className="w-full max-w-md lg:max-w-lg bg-[#E1EFF2] rounded-2xl shadow-sm p-4 md:p-8 mr-0 lg:mr-8 border border-[#D3E8EC] h-full flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              style={{ backgroundColor: '#F6FEFF', border: '1px solid rgba(0, 85, 105, 0.67)' }}
              required
            />
          </div>
