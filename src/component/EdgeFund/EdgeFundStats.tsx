...
const EdgeFundStats = () => {
    ...
    const stats = [
        { label: language === 'nl' ? <>Jaarlijks netto<br />rendementsdoel</> : <>Annual net<br />return target</>, value: "20%" },
        { label: language === 'nl' ? <>Totaal cumulatief<br />resultaat</> : <>Total cumulative<br />result</>, value: "143.11%" },
        { label: language === 'nl' ? <>Maandelijks netto<br />rendementsdoel</> : <>Monthly net<br />return target</>, value: "1.66%" },
        { label: language === 'nl' ? "Beste maand" : "Best month", value: "8.15%" },
    ];
